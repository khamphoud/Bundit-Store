...
import 'package:Bundit_Store/adBoxAdd.dart';
import 'package:Bundit_Store/editAdBox.dart';
import 'package:Bundit_Store/editProduct.dart';
import 'package:Bundit_Store/service/GetAdBox.dart';
import 'package:Bundit_Store/service/getProductApi.dart';
import 'package:Bundit_Store/widget/skeletonLoad.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/home': (context) => MyHomePage(userId: ''),
                  ...
                  builder: (context, snap) {
                    if (snap.connectionState == ConnectionState.waiting) {
                      ...
                      if (snap.hasData) {
                        ...
                        return Container(
                          height: 300,
                          child: const Text('ມີບາງຢ່າງຜິດພາດ'),
                        );
                      }
                    }
                    return Container(
